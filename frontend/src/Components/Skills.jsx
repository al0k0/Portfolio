...
const Skills = () => {
  ...
  const skills = [
    ...
    { name: "Generative AI / API Integration", percentage: "70%" },
  ...
  return (
    <div id="skills" className="bg-green-900 py-12" ref={SkillSectionRef}>
      ...
      <div className="space-y-4 lg:space-y-6 mt-10 lg:px-36 px-4">
        {skills.map((skill, index) => (
          <div key={index} className="relative">
            <div className="bg-gray-400 w-full h-6 lg:h-7 rounded-2xl">
              <div
                className="bg-green-500 h-6 lg:h-7 rounded-2xl border transition-all duration-1000"
